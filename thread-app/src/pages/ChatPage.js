...
const ChatPage = () => {
  ...
  useEffect(() => {
     socket?.on('messsagesSeen', ({conversationId})=>{
  ...
  const handleConversationSearch = async (e) => {
    ...
    try {
      ...
      //if user already in a conversation with the searched user
  ...
  return (
    <Box position={'absolute'} left={'50%'} transform={'translateX(-50%)'} p={4}
      width={{
        base: "100%",
        md: "80%",
        lg: "750px"
